...
export default {
    GET: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            let directions = yield model.GET();
            if (!directions)
    ...
    GETBYSCIENCES: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            let directions = yield model.GETBYSCIENCES(req.body);
            if (!directions)
                return next(new NotFoundError(404, "no data"));
            res.status(200).json({
                status: 200,
    ...
    POST: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            let direction = yield model.POST(req.body);
            if (!direction)
    ...
    PUT: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            let direction = yield model.PUT(req.body, req.params);
            if (!direction)
                return next(new RequestError(400, "bad request"));
            res.status(202).json({
                status: 202,
    ...
    DELETE: (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            let direction = yield model.DELETE(req.params);
            if (!direction)
                return next(new RequestError(400, "bad request"));
            res.status(202).json({
                status: 202,
